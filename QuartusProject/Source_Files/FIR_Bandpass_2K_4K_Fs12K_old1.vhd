-- -------------------------------------------------------------
--
-- Module: FIR_Bandpass_2K_4K_Fs12K
-- Generated by MATLAB(R) 9.2 and the Filter Design HDL Coder 3.1.1.
-- Generated on: 2017-06-02 09:31:05
-- -------------------------------------------------------------
...
ENTITY FIR_Bandpass_2K_4K_Fs12K IS
...
END FIR_Bandpass_2K_4K_Fs12K;

-- ### Starting VHDL code generation process for filter: FIR_Bandpass_2K_4K_Fs12K
-- ### Clock rate is 16 times the input sample rate for this architecture.
-- ### HDL latency is 3 samples

----------------------------------------------------------------
--Module Architecture: FIR_Bandpass_2K_4K_Fs12K
----------------------------------------------------------------
ARCHITECTURE rtl OF FIR_Bandpass_2K_4K_Fs12K IS
  -- Local Functions
  -- Type Definitions
  TYPE delay_pipeline_type IS ARRAY (NATURAL range <>) OF signed(31 DOWNTO 0); -- sfix32_En28
  TYPE sumdelay_pipeline_type IS ARRAY (NATURAL range <>) OF signed(70 DOWNTO 0); -- sfix71_En60
  -- Constants
...
BEGIN
  ...
  add_temp_2 <= resize(acc_out_1, 72) + resize(acc_out_2, 72);
