...
-- Generated on: 2017-06-06 19:53:57
-- -------------------------------------------------------------
...
ENTITY FIR_Bandpass_2K_4K_Fs12K IS
   PORT( clk                             :   IN    std_logic;                     -- clk = 16 * Fs_input = 16 * 12K = 129K 
         clk_enable                      :   IN    std_logic; 
         reset                           :   IN    std_logic; 
         filter_in                       :   IN    std_logic_vector(31 DOWNTO 0); -- sfix32_En28  -- Fs_input = 12K
...
--% ### Successful completion of VHDL code generation process for filter: FIR_Bandpass_2K_4K_Fs12K
