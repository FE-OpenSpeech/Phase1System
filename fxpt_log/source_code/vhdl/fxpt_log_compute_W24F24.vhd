...
entity fxpt_log_compute_W24F24 is
   port (
      clock	 : in  std_logic;
      reset	 : in  std_logic;
      x	     : in  std_logic_vector(23 downto 0);
      start	 : in  std_logic;
      y      : out std_logic_vector(23 downto 0);   -- y=ln(x)
      done   : out std_logic
   );
end entity;

architecture rtl of fxpt_log_compute_W24F24 is
                                                       
   component fxpt_log_ROM_b_coef_W24F24                
      port (                                           
         clock     : in  std_logic;                    
   ...
   component fxpt_log_ROM_lnb_coef_W24F24              
      port (                                           
         clock     : in  std_logic;                    
         address   : in  std_logic_vector( 4 downto 0);
   ...
   signal xi                :   signed(23 downto 0);
   signal yi                :   signed(23 downto 0);
   signal p                 :   signed(47 downto 0);
   signal b_coef            :   std_logic_vector(23 downto 0);
   signal lnb_coef          :   std_logic_vector(23 downto 0);
   signal lnb_coef_z1       :   signed(23 downto 0);
   ...
   constant y0              :   signed(23 downto 0) := (others => '0');
   constant c1              :   signed(47 downto 0) := "011111111111111111111111111111111111111111111111";
   constant c24             :   unsigned(6 downto 0) := "0011000";
 
begin

  ROM1 : fxpt_log_ROM_b_coef_W24F24
     port map (
        clock    => clock,
  ...
  ROM2 : fxpt_log_ROM_lnb_coef_W24F24
     port map (
        clock    => clock,
        address  => std_logic_vector(step_counter(4 downto 0)),
        lnb_coef => lnb_coef
