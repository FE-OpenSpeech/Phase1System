...
entity fxpt_exp_compute_W28F24 is
   port (
      clock	: in  std_logic;
      reset	: in  std_logic;
...
architecture rtl of fxpt_exp_compute_W28F24 is
                                                       
   component fxpt_exp_ROM_bp_coef_W28F24               
      port (                                           
         clock     : in  std_logic;                    
   ...
   component fxpt_exp_ROM_bn_coef_W28F24               
      port (                                           
         clock     : in  std_logic;                    
         address   : in  std_logic_vector( 4 downto 0);
   ...
   component fxpt_exp_ROM_lnbp_coef_W28F24             
      port (                                           
         clock     : in  std_logic;                    
         address   : in  std_logic_vector( 4 downto 0);
   ...
   component fxpt_exp_ROM_lnbn_coef_W28F24             
      port (                                           
         clock     : in  std_logic;                    
         address   : in  std_logic_vector( 4 downto 0);
   ...
   signal yi                  :   signed(27 downto 0);
   signal yp                  :   signed(55 downto 0);
   signal yn                  :   signed(55 downto 0);
   signal bp_coef             :   std_logic_vector(27 downto 0);
   signal bn_coef             :   std_logic_vector(27 downto 0);
   signal lnbp_coef           :   std_logic_vector(27 downto 0);
   signal lnbn_coef           :   std_logic_vector(27 downto 0);
   signal bp_coef_z1          :   signed(27 downto 0);
   signal bn_coef_z1          :   signed(27 downto 0);
   signal lnbp_coef_z1        :   signed(27 downto 0);
   signal lnbn_coef_z1        :   signed(27 downto 0);
   signal Dp                  :   signed(27 downto 0);
   signal Dn                  :   signed(27 downto 0);
   signal Dz                  :   signed(27 downto 0);
   signal Dp_abs              :   unsigned(27 downto 0);
   signal Dn_abs              :   unsigned(27 downto 0);
   signal Dz_abs              :   unsigned(27 downto 0);
   ...
   signal x0                  :   signed(27 downto 0);
   signal y0                  :   signed(27 downto 0);
   constant count22  :   unsigned(6 downto 0) := "0010110";
 
begin

  ROM1 : fxpt_exp_ROM_bp_coef_W28F24
     port map (
        clock    => clock,
  ...
  ROM2 : fxpt_exp_ROM_bn_coef_W28F24
     port map (
        clock    => clock,
        address  => std_logic_vector(step_counter(4 downto 0)),
        bn_coef   => bn_coef
  ...
  ROM3 : fxpt_exp_ROM_lnbp_coef_W28F24
     port map (
        clock    => clock,
        address  => std_logic_vector(step_counter(4 downto 0)),
        lnbp_coef => lnbp_coef
  ...
  ROM4 : fxpt_exp_ROM_lnbn_coef_W28F24
     port map (
        clock    => clock,
        address  => std_logic_vector(step_counter(4 downto 0)),
        lnbn_coef => lnbn_coef
   ...
   compute : process (clock)
      ...
      variable vp   :   signed(55 downto 0);
   begin
         if (rising_edge(clock)) then
               ...
               case state is
                     ...
                     when state_start =>
                           x0                  <= signed(x);  -- x0=x
                           y0                  <= "0001000000000000000000000000";  -- y0=1
                     ...
                     when state_start_update =>
                           if Dz_abs < Dp_abs then    -- Note: Dn is not checked for i=0 since it is undefined
                                 ...
                                 vp := y0 * bp_coef_z1;
                                 yi <= vp( 51 downto 24); -- first product P = Y0 * (1+2^(-i))  (i=0)
                           end if;
